...
type GetOrderResponse struct {
	...
	Status        OrderStatus            `protobuf:"varint,6,opt,name=status,proto3,enum=api.v1.orderservice.OrderStatus" json:"status,omitempty"`
...
const file_order_service_proto_rawDesc = "" +
	"\n" +
	"\x13order-service.proto\x12\x13api.v1.orderservice\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x01\n" +
	...
	"\bquantity\x18\x03 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00R\bquantity\x12\x1d\n" +
	"\x05total\x18\x04 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x05total\"0\n" +
	"\x13CreateOrderResponse\x12\x19\n" +
	"\border_id\x18\x01 \x01(\x03R\aorderId\"5\n" +
	"\x0fGetOrderRequest\x12\"\n" +
	"\border_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\aorderId\"\xc7\x02\n" +
	...
	"\x06status\x18\x06 \x01(\x0e2 .api.v1.orderservice.OrderStatusR\x06status\x129\n" +
	"\n" +
	...
	"\x16ORDER_STATUS_COMPLETED\x10\x052\x94\x03\n" +
	"\fOrderService\x12{\n" +
	"\vCreateOrder\x12'.api.v1.orderservice.CreateOrderRequest\x1a(.api.v1.orderservice.CreateOrderResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/api/v1/orders\x12z\n" +
	"\bGetOrder\x12$.api.v1.orderservice.GetOrderRequest\x1a%.api.v1.orderservice.GetOrderResponse\"!\x82\xd3\xe4\x93\x02\x1b\x12\x19/api/v1/orders/{order_id}\x12\x8a\x01\n" +
	"\vCancelOrder\x12'.api.v1.orderservice.CancelOrderRequest\x1a(.api.v1.orderservice.CancelOrderResponse\"(\x82\xd3\xe4\x93\x02\"\" /api/v1/orders/{order_id}/cancelBl\x92AY\x123\n" +
